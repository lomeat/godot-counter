...
/** @type {string} */
const CACHE_VERSION = '1738151037|7639140445';
/** @type {string} */
const CACHE_PREFIX = 'Counter-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'counter.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["counter.html","counter.js","counter.offline.html","counter.icon.png","counter.apple-touch-icon.png","counter.worker.js","counter.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["counter.wasm","counter.pck"];
